...
public class Assassin extends Kit {
	...
	public List<ItemStack> getItems() {
		...
		ItemStack assassin = new ItemBuilder(Material.IRON_FENCE).name("&aClick to go invisible and assassinate someone").build();
	...
	public ItemStack[] getArmor() {
		return new ItemStack[] { new ItemStack(Material.GOLD_HELMET), new ItemStack(Material.CHAINMAIL_CHESTPLATE), new ItemStack(Material.GOLD_LEGGINGS), new ItemStack(Material.IRON_BOOTS) };
	}
