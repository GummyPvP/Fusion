...
public class Bounds implements ConfigurationSerializable {
	...
	public void generateHollowCube(int radius) { // Thanks Bukkit forums
		...
		final byte floorData = (byte) new Random().nextInt(16); // for random color
		final byte wallData = (byte) new Random().nextInt(16); // for random color - broken in Spigot 1.15.2, can be fixed another time
