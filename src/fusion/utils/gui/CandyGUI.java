...
public class CandyGUI extends GUI {
	...
	public void populateInventory() {
		...
		ItemStack buyKits = new ItemBuilder(Material.CLOCK).name("&6Purchase Kits (in-game currency)").build();
		...
		ItemStack comingSoon = new ItemBuilder(Material.WHITE_WOOL).name("&4Coming Soon!").build();
