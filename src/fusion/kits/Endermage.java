...
public class Endermage extends Kit {
	...
	public List<ItemStack> getItems() {
		...
		ItemStack hairyBalls = new ItemBuilder(Material.END_PORTAL_FRAME).name("&5Endermage Teleporter").lore("Teleport the people above and below you directly to this portal!").build();
